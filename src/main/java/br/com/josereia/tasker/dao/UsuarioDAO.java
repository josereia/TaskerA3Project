package br.com.josereia.tasker.dao;
...
import br.com.josereia.tasker.connection.ConnectionFactory;
	...
	public void create(UsuarioDTO usuariodto) {
		...
		try {
			...
			if (stmt.executeUpdate() > 0) {
				...
				throw new SQLException("Usuário n�o cadastrado.");
			}
	...
	public UsuarioDTO read(String nome, String empresa) {
		...
		try {
			...
			if (rs.next()) {
				...
				throw new SQLException("Usuário n�o encontrado.");
			}
		} catch (SQLException e) {
			JOptionPane.showMessageDialog(null, e.getMessage(), "Erro!", JOptionPane.ERROR_MESSAGE);
